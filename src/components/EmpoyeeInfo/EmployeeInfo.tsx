...
const EmployeeInfo: React.FC<IEmployeeInfoProps> = (props) => {
  ...
  return (
    <div className="flex flex-col md:grid md:grid-cols-[160px_1fr] items-center gap-y-4 md:gap-x-12 md:gap-y-2">
      ...
      <div className="text-2xl sm:text-[2rem] md:text-[3rem] font-bold tracking-widest leading-snug text-center md:text-left">
